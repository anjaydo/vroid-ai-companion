...
import { CameraControls, Environment, Gltf, PerspectiveCamera } from "@react-three/drei";
import { Bloom, EffectComposer } from "@react-three/postprocessing";
import { Euler, Vector3 } from "three";

export const Experience = ({ children }) => {
  // Write camera position and rotation with and many in leva
  ...
  return (
    <>
      ...
      <PerspectiveCamera
        makeDefault
        position={new Vector3(cameraProps.positionX, cameraProps.positionY, cameraProps.positionZ)}
        rotation={new Euler(cameraProps.rotationX, cameraProps.rotationY, cameraProps.rotationZ)}
        fov={cameraProps.fov}
